"""The network math: tokens in, 768-d molecular embedding out.

Docs: https://alix559.github.io/mat-gram01/graph.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_graph.ipynb.

# %% ../nbs/03_graph.ipynb #75d996f1
...
__all__ = ['FeatureMap', 'InnerLinearAttention', 'RotaryEmbedding', 'RotateAttentionLayer', 'TransformerEncoderLayer',
           'TransformerEncoderBlocks', 'MoLEncoder', 'AutoEncoderEncoder', 'AutoEncoder', 'MoLDecoder', 'SmiTedModel',
           'build_graph']

# %% ../nbs/03_graph.ipynb #1325a746
...
# %% ../nbs/03_graph.ipynb #7758cd1d
class AutoEncoderEncoder(Module):
    "Flattened token states → 768-d latent (AE encoder only)."
...
class MoLDecoder(Module):
    "Decoder side used only for its autoencoder encoder at inference."
...
# %% ../nbs/03_graph.ipynb #6838999b
class SmiTedModel(Module):
    "SMI-TED encode graph: SMILES token ids → 768-d molecular embedding."
    ...
    def __call__(
        ...
        return self.decoder.autoencoder.encoder(flat)


# %% ../nbs/03_graph.ipynb #7dc3a7cf
def build_graph(
    config: SmiTedModelConfig,
    state_dict: Mapping[str, DLPackArray | WeightData],
) -> Graph:
    "Build the MAX ``Graph`` for SMI-TED encode."
